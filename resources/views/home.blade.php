...
<link rel="stylesheet" href="{{URL::asset('css/simplyCountdown.theme.default.css')}}" />
<style>
.owl-demo{
...
<div class="rowQuestion">
  <div class="row">
    <div class="container">
      <div class="homeTitle">
        <h2>Welcome To Community App !</h2>
        <img src="http://cdn.playbuzz.com/cdn/736e2c51-d62c-41cf-8241-3a37514b3811/391a0747-3748-4128-bd94-88c5c9d4f716.JPG" style="height:200px;position:relative;background-repeat:repeat-x;width:100%;opacity:0.2;" alt="">
      </div>
      ...
      <div class="question_box col-sm-9 col-md-9">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <img src="{{URL::asset('images/main-qimg-d5342af4207d0ac3a7d43a4a930ea571.png')}}" alt="user image">&nbsp;&nbsp;&nbsp;How to install Laravel?
            <span class="timediff badge" >20 mintue ago</span>
          </div>
          <div class="panel-body">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Omnis quia optio minus quasi quae assumenda consectetur minima quos quaerat aspernatur! Vel quasi repellendus debitis. Placeat quas tenetur illo ratione veniam
            <a href="{{ route('singlepost') }}">read more</a><hr>
            <div class="col-sm-3" >
